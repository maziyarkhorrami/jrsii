...
public class UserHomePage extends CustomComponent implements View {
	...
	public UserHomePage() {
		...
		button_SchuelerStudent.addClickListener(new Button.ClickListener() {
			
			@Override
			public void buttonClick(ClickEvent event) {
				navigator.addView(UserSchueler.USER_SCHUELER_PAGE, new UserSchueler());
				navigator.navigateTo(UserSchueler.USER_SCHUELER_PAGE);
				
			}
		});
		
		button_Lehrer.addClickListener(new Button.ClickListener() {
			
			@Override
			public void buttonClick(ClickEvent event) {
				navigator.addView(UserLehrer.USER_LEHRER, new UserSchueler());
				navigator.navigateTo(UserLehrer.USER_LEHRER);
				
			}
		});
		
		button_Kurse.addClickListener(new Button.ClickListener() {
			
			@Override
			public void buttonClick(ClickEvent event) {
				navigator.addView(UserKurse.USER_KURSE, new UserSchueler());
				navigator.navigateTo(UserSchueler.USER_SCHUELER_PAGE);
				
			}
		});
		
		button_Marketing.addClickListener(new Button.ClickListener() {
			
			@Override
			public void buttonClick(ClickEvent event) {
				navigator.addView(UserMarketing.USER_MARKETING, new UserSchueler());
				navigator.navigateTo(UserMarketing.USER_MARKETING);
				
			}
		});
		
		button_SetUp.addClickListener(new Button.ClickListener() {
			
			@Override
			public void buttonClick(ClickEvent event) {
				navigator.addView(UserSetUp.USER_SETUP, new UserSchueler());
				navigator.navigateTo(UserSetUp.USER_SETUP);
				
			}
		});
		
		button_BenutzerOptionen.addClickListener(new Button.ClickListener() {
			
			@Override
			public void buttonClick(ClickEvent event) {
				navigator.addView(UserBenutzerOptionen.USER_BENUTZER_OPTIONEN_PAGE, new UserSchueler());
				navigator.navigateTo(UserBenutzerOptionen.USER_BENUTZER_OPTIONEN_PAGE);
